...
import xi.zhao.wallet.util.BitmapFragment;
import xi.zhao.wallet.util.Nfc;
import xi.zhao.wallet.util.Qr;
...
public final class WalletAddressFragment extends Fragment
{
	...
	private void updateView()
	{
		...
		if (!selectedAddress.equals(lastSelectedAddress))
		{
			...
			//bitcoinAddressLabel.setText(WalletUtils.formatAddress(selectedAddress, 4,
			//		20));
			bitcoinAddressLabel.setText(selectedAddress.toString());
